...
void Device::dump(void)
{
	...
	qDebug("\t\t/* --- generated by device.dump() --- */\n");
	qDebug("\t\tdevice->bytesPerWordEEPROM = %d;\n", bytesPerWordEEPROM);
	qDebug("\t\tdevice->blankValue = 0x%08x;\n", blankValue);
	qDebug("\t\tdevice->flashWordMask = 0x%08x;\n", flashWordMask);
	qDebug("\t\tdevice->configWordMask = 0x%08x;\n", configWordMask);
	qDebug("\t\tdevice->name = \"%s\";\n", name.toStdString().c_str());
	qDebug("\t\tdevice->bytesPerAddressFLASH = %d;\n", bytesPerAddressFLASH);
	qDebug("\t\tdevice->writeBlockSizeFLASH = %d;\n", writeBlockSizeFLASH);
	qDebug("\t\tdevice->eraseBlockSizeFLASH = %d;\n", eraseBlockSizeFLASH);
	qDebug("\t\tdevice->startFLASH  = 0x%08x;\n", startFLASH);
	qDebug("\t\tdevice->endFLASH    = 0x%08x;\n", endFLASH);
	qDebug("\t\tdevice->startBootloader = 0x%08x;\n", startBootloader);
	qDebug("\t\tdevice->endBootloader = 0x%08x;\n", endBootloader);
	qDebug("\t\tdevice->startEEPROM = 0x%08x;\n", startEEPROM);
	qDebug("\t\tdevice->endEEPROM   = 0x%08x;\n", endEEPROM);
	qDebug("\t\tdevice->startUser   = 0x%08x;\n", startUser);
	qDebug("\t\tdevice->endUser     = 0x%08x;\n", endUser);
	qDebug("\t\tdevice->startConfig = 0x%08x;\n", startConfig);
	qDebug("\t\tdevice->endConfig   = 0x%08x;\n", endConfig);
	qDebug("\t\tdevice->startGPR    = 0x%08x;\n", startGPR);
	qDebug("\t\tdevice->endGPR      = 0x%08x;\n", endGPR);
	qDebug("\t\tdevice->startIVT    = 0x%08x;\n", startIVT);
	qDebug("\t\tdevice->endIVT      = 0x%08x;\n", endIVT);
	qDebug("\t\tdevice->startAIVT   = 0x%08x;\n", startAIVT);
	qDebug("\t\tdevice->endAIVT     = 0x%08x;\n", endAIVT);
	qDebug("\t\tdevice->bytesPerWordFLASH = %d;\n", bytesPerWordFLASH);

	/* configWords */
	qDebug("\t\t\n");
	qDebug("\t\tDevice::ConfigWord word;\n");
	qDebug("\t\tDevice::ConfigField field;\n");
	qDebug("\t\tDevice::ConfigFieldSetting setting;\n");
	qDebug("\t\t\n");
	n = 0; i = 0; j = 0;
	foreach(ConfigWord word, configWords)
	{
		qDebug("\t\tword.rowId = 0x%08x;\n", word.rowId);
		qDebug("\t\tword.name = \"%s\";\n", word.name.toStdString().c_str());
		qDebug("\t\tword.address = 0x%08x;\n", word.address);
		qDebug("\t\tword.defaultValue = 0x%08x;\n", word.defaultValue);
		qDebug("\t\tword.implementedBits= 0x%08x;\n", word.implementedBits);
		qDebug("\t\tdevice->configWords.append(word);\n");
		i = 0;
		foreach(ConfigField field, word.fields)
		{
			qDebug("\t\tfield.rowId = 0x%08x;\n", field.rowId);
			qDebug("\t\tfield.name = \"%s\";\n", field.name.toStdString().c_str());
			qDebug("\t\tfield.cname = \"%s\";\n", field.cname.toStdString().c_str());
			qDebug("\t\tfield.description = \"%s\";\n", 
				field.description.toStdString().c_str());
			qDebug("\t\tfield.mask = 0x%08x;\n", field.mask);
			qDebug("\t\tfield.width = 0x%08x;\n", field.width);
			qDebug("\t\tfield.hidden = 0x%08x;\n", field.hidden);
			qDebug("\t\tdevice->configWords[%d].fields.append(field);\n", n);

			j=0;
			foreach(ConfigFieldSetting settings, field.settings)
			{
				qDebug("\t\tsetting.name = \"%s\";\n",
					settings.name.toStdString().c_str());
				qDebug("\t\tsetting.cname = \"%s\";\n", 
					settings.cname.toStdString().c_str());
				qDebug("\t\tsetting.description = \"%s\";\n", 
					settings.description.toStdString().c_str());
				qDebug("\t\tsetting.bitMask = 0x%08x;\n", settings.bitMask);
				qDebug("\t\tsetting.bitValue = 0x%08x;\n", settings.bitValue);
				qDebug("\t\tdevice->configWords[%d].fields[%d].settings.append(setting);\n", n, i);
				j++;
